				...
				<div class="cart-header col-md-6">
					<div class="cart-sec simpleCart_shelfItem">
						...
						<div class="cart-item-info">
							...
							<a class="btn btn-info" href="javascript:buy(${item.good.id});">➕</a>
							<a class="btn btn-warning" href="javascript:lessen(${item.good.id});">➖</a>
							<a class="btn btn-danger" href="javascript:deletes(${item.good.id});">🗑️</a>
						</div>
