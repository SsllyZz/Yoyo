...
import com.yoyo.dao.ItemsDao;
import com.yoyo.dao.OrdersDao;
...
public class OrderService implements IOrderService {
    ...
    public Orders add(Goods good) {
        ...
        Users seller=usersDao.selectById(good.getOwnerId());
    ...
    public List<Orders> getList(byte status, int page, int row) {
        ...
        for (Orders order : orderList) {
            ...
            order.setUser(usersDao.selectById(order.getUserId()));
            order.setSeller(usersDao.selectById(order.getSellerId()));
        }
    ...
    public List<Orders> getListBySellerid(int userid) {
        return orderDao.getListBySellerid(userid);
    }
    ...
    private Items addItem(Goods good) {
        ...
        item.setGood(iGoodService.get(item.getGoodId()));
        return item;
    }
